...
- Level 1: Terrestrial Realm
  - Level 2: [T6 Polar/Alpine (cryogenic) functional biome](https://global-ecosystems.org/explore/biomes/T6){target="GET"}
    - Level 3: [T6.1 Ice sheets, glaciers and perennial snowfields](https://global-ecosystems.org/explore/groups/T6.1)
