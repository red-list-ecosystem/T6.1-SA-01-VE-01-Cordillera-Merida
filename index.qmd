...
This assessment is summarised in  @FerrerParis_Glacier_Merida_2023.

## External links

The html version of this report is available in GitHub pages:
<https://red-list-ecosystem.github.io/T6.1-SA-01-VE-01-Cordillera-Merida/>{target='ext'}

A PDF version of this assessment report has been uploaded to EcoEvoRxiv, and is available under the DOI [10.32942/X2VK54](https://doi.org/10.32942/X2VK54){target='ext'}.

Reproducible code and data are available as an OSF project with DOI [10.17605/OSF.IO/Y3279](https://doi.org/10.17605/OSF.IO/Y3279){target='ext'}.

We also wrote a couple of blog entries dedicated to the [fading memories of tropical glaciers](https://jrfep.quarto.pub/ecosystems-of-the-world/posts/T6.1-tropical-glaciers/){target='ext'} and the [loss of a delicate balance](https://www.oryxthejournal.org/blog/vanishing-tropical-glaciers-in-venezuela-a-delicate-balance-has-been-lost/){target='ext'}.
